	...
	IGameEventHandler<EquipmentDeployedEvent>
{
	...
	[Property]
	[Category( "Base" )]
	public List<string> InputActions { get; set; } = new() { "Attack1" };
	...
	[Property]
	[Category( "Base" )]
	public Action<InputWeaponComponent> OnInputAction { get; set; }

	private bool RunningWhileDeployed { get; set; }
