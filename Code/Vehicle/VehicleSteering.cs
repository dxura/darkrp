...
public sealed class Steering : Component
{
	...
	protected override void OnFixedUpdate()
	{
		...
		{
			var targetRotation =
				Rotation.FromYaw( MaxSteeringAngle * inputState.direction.y ) * Rotation.From( Offset );
			wheel.Transform.LocalRotation = Rotation.Lerp( wheel.Transform.LocalRotation, targetRotation,
				Time.Delta * SteeringSmoothness );
		}
	}
}
