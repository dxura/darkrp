...
public abstract class ScreenShake
{
	public class Random : ScreenShake
	{
		...
		public override bool Update( CameraComponent camera )
		{
			...
			camera.Transform.LocalPosition +=
				(camera.Transform.LocalRotation.Right * random.x + camera.Transform.LocalRotation.Up * random.y) *
				(1f - Progress) * Size;
	...
	public class Fov : ScreenShake
	{
		...
		public override bool Update( CameraComponent camera )
		{
			...
			var cc = PlayerState.Local.Player?.CameraController;
	...
	public class Punch : ScreenShake
	{
		...
		public override bool Update( CameraComponent camera )
		{
			...
			camera.Transform.LocalPosition += (camera.Transform.LocalRotation.Right * random.x +
			                                   camera.Transform.LocalRotation.Up * random.y +
			                                   camera.Transform.LocalRotation.Backward * random.z) * c * Size;
