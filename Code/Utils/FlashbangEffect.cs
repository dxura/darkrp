...
public class FlashbangEffect : Component
{
	...
	protected override void OnEnabled()
	{
		...
		DspProcessor ??= new DspProcessor( "weird.4" );
	...
	protected override void OnStart()
	{
		...
		Aberration.Scale = 1f;
		Aberration.Offset = new Vector3( 6f, 10f, 3f );
	...
	private void RenderEffect( SceneCamera camera )
	{
		...
		Graphics.DrawQuad( rect, Material.UI.Basic, new Color( 1f, 1f, 1f, RenderAlpha ) );
	}
}
