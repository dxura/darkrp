...
public class MountPoint
{
	...
	public bool Mount( Equipment equipment, Player player )
	{
		...
		if ( Mounted.Count < GameObjects.Count )
		{
			...
			{
				Transform = new Transform(), Parent = mountSpot, StartEnabled = true
			} );
			...
			if ( inst.IsValid() )
			{
				...
				{
					renderer.Enabled = player.IsProxy;
					renderer.RenderType = !player.IsProxy
	...
	public bool Unmount( Equipment equipment, Player player )
	{
