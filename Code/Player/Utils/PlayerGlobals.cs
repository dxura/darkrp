...
public class PlayerGlobals : GlobalComponent, IGameEventHandler<ModifyDamageGlobalEvent>
{
	...
	[Property]
	[Group( "Damage" )]
	public float BaseArmorReduction { get; set; } = DefaultArmorReduction;
	...
	[Property]
	[Group( "Damage" )]
	public float BaseHelmetReduction { get; set; } = DefaultHelmetReduction;
