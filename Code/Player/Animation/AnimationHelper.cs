...
public sealed class AnimationHelper : Component
{
	...
	protected override void OnUpdate()
	{
		...
		if ( IkLeftFoot.IsValid() && IkLeftFoot.Active )
		{
			SetIk( "foot_left", IkLeftFoot.Transform.World );
		}
		else
		{
			ClearIk( "foot_left" );
		...
		if ( IkRightFoot.IsValid() && IkRightFoot.Active )
		{
			SetIk( "foot_right", IkRightFoot.Transform.World );
		}
		else
		{
			ClearIk( "foot_right" );
