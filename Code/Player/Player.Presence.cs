...
{
	[Property, Feature("Misc"), Group("Footsteps")] private float FootstepBaseVolume { get; set; } = 5f;
	[Property, Feature("Misc"), Group("Footsteps")] private float FootstepScale { get; set; } = 1f;
	[Property, Feature("Misc"), Group("Footsteps")] private float SprintFootstepScale { get; set; } = 2f;
	
	[Property, Feature("Misc"), Group("Torch")] private readonly SpotLight _torchSpotLight = null!;
	[Property, Feature("Misc"), Group("Torch")] private readonly SoundEvent _torchToggleSound = null!;
	...
	private void OnFixedUpdatePresence()
	{
		...
		if ( _timeSinceStep >= GetStepFrequency() && Velocity.Length > 50f )
		{
			Footstep();
		}
